...
const NAV_LINKS = [
  { href: '/', label: 'Explore Repos', icon: Compass },
  { href: '/bookmarks', label: 'My Contribution Pipeline', icon: BookmarkCheck, badge: 'Saved' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-3 group shrink-0">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-500 flex items-center justify-center text-black shadow-lg shadow-emerald-500/20 group-hover:scale-105 transition-transform">
            <GitPullRequest className="w-5 h-5 fill-black font-black" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="text-lg font-black tracking-tight text-white font-outfit">
                GitMatch<span className="text-emerald-400">.AI</span>
              </span>
            ...
            <p className="text-[10px] text-slate-400 font-mono hidden sm:block">
              Open Source Discovery Engine &amp; AI First-Contribution Matchmaker
            </p>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          >
            ...
            <span className="hidden sm:inline">My PR Pipeline</span>
          </Link>
