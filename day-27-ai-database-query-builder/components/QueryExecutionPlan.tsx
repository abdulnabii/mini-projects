    ...
    <div className="p-6 sm:p-8 rounded-2xl bg-[#0d1527] border border-[#1e293b] shadow-xl space-y-6 font-mono">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-[#1e293b] pb-4">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-[#111827] border border-emerald-500/30 hover:bg-emerald-500/10 text-emerald-300 text-xs font-mono font-bold transition-all duration-150 flex items-center gap-1.5 cursor-pointer hover:border-emerald-400"
        >
          {copiedMigration ? (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
        <div className="p-3.5 rounded-xl bg-[#111827] border border-[#1e293b] space-y-1 hover:border-emerald-500/40 transition-colors">
        ...
        <div className="p-3.5 rounded-xl bg-[#111827] border border-[#1e293b] space-y-1 hover:border-amber-500/40 transition-colors">
        ...
        <div className="p-3.5 rounded-xl bg-[#111827] border border-[#1e293b] space-y-1 hover:border-cyan-500/40 transition-colors">
      ...
      <div className="space-y-2.5 pt-1">
        ...
        <div className="space-y-2.5">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="p-3.5 rounded-xl border border-[#1e293b] bg-[#111827] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 hover:border-emerald-500/40 transition-colors duration-150"
            >
      ...
      <div className="p-4 rounded-xl bg-[#050811] border border-[#1e293b] space-y-2 text-xs">
        ...
        <pre className="p-3 rounded-lg bg-[#0b0f19] border border-[#1e293b] text-[11px] text-emerald-300 font-mono leading-relaxed overflow-x-auto selection:bg-emerald-500/30">
          {migrationScript}
        </pre>
      </div>
    </div>
