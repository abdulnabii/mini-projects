...
export default function Footer() {
  return (
    <footer className="border-t border-slate-800 bg-[#06080e] text-slate-400 font-mono text-xs py-8 mt-auto">
      <div className="mx-auto flex max-w-7xl flex-col sm:flex-row items-center justify-between gap-4 px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <Terminal className="h-4 w-4 text-amber-400" />
          <span className="font-bold text-slate-200">PromptCraft.AI</span>
          <span className="text-slate-600">|</span>
          <span>Precision Prompt Engineering Framework</span>
        </div>
