...
import { Heart, Globe, Box, Sparkles } from 'lucide-react';
    ...
    <footer className="border-t border-slate-800/80 bg-[#04080e] py-8 text-center font-mono text-xs text-slate-500">
      <div className="max-w-7xl mx-auto px-4 space-y-3">
        <div className="flex items-center justify-center gap-2 text-slate-400">
          ...
          <span className="text-white font-bold font-mono">OmniData.3D</span>
          <span>•</span>
          <span>3D WebGL Data Visualization &amp; AI Spatial Narrative Engine</span>
        </div>

        <p className="text-[11px] text-slate-500 max-w-xl mx-auto leading-relaxed prose-text">
          Interactive Three.js WebGL globe projections, force-directed network graphs, 3D isometric bar matrices, and particle scatter clouds powered by Gemini 1.5 Flash.
        </p>
