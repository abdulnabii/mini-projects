...
import { Heart, Wallet, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <footer className="border-t border-slate-800/80 bg-[#04080e] py-8 text-center font-mono text-xs text-slate-500">
      <div className="max-w-7xl mx-auto px-4 space-y-3">
        <div className="flex items-center justify-center gap-2 text-slate-400">
          ...
          <span className="text-white font-bold font-mono">WealthPulse.AI</span>
          <span>•</span>
          <span>AI Personal Finance &amp; Financial Independence (FIRE) Intelligence</span>
        </div>

        <p className="text-[11px] text-slate-500 max-w-xl mx-auto leading-relaxed prose-text">
          Deterministic compound interest calculations, Trinity Study 4% safe withdrawal rules, and debt amortization models powered by Gemini 1.5 Flash.
        </p>
