...
const TIME_SLOTS = [
  { label: 'Morning Doses', time: '08:00', icon: Sunrise, color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/30' },
  { label: 'Afternoon Doses', time: '13:00', icon: Sun, color: 'text-yellow-400', bg: 'bg-yellow-500/10 border-yellow-500/30' },
  { label: 'Evening Doses', time: '20:00', icon: Sunset, color: 'text-orange-400', bg: 'bg-orange-500/10 border-orange-500/30' },
  { label: 'Bedtime Doses', time: '22:00', icon: Moon, color: 'text-indigo-400', bg: 'bg-indigo-500/10 border-indigo-500/30' },
];
  ...
  const playVoiceReminder = (med: Medication, time: string) => {
    ...
    if (typeof window !== 'undefined' && 'speechSynthesis' in window) {
      ...
      const utterance = new SpeechSynthesisUtterance(
        `Medication Reminder. It is time to take ${med.name} ${med.dosage}. ${med.instructions}.`
      );
      utterance.rate = 0.95;
    ...
    <div className="space-y-6 font-mono">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-bold text-white text-base font-outfit">
              Today's Medication Dosing Timeline
            </h3>
      ...
      <div className="space-y-6">
        {TIME_SLOTS.map((slot) => {
          ...
          // Filter medications scheduled for this time slot
          ...
          return (
            <div
              key={slot.time}
              className="p-6 rounded-3xl bg-[#0d1117] border border-slate-800 shadow-xl space-y-4"
            >
              {/* Slot Header */}
                  ...
                  return (
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="px-2 py-0.5 rounded-md bg-slate-900 border border-slate-800 text-[10px] text-cyan-400 font-bold">
                                {med.dosage}
                              </span>
                            </div>
                          ...
                          <button
                            ...
                            className="p-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-emerald-400 transition-colors cursor-pointer"
                        ...
                        {/* Instructions */}
                        <div className="p-2.5 rounded-xl bg-[#0d1117] border border-slate-800/80 text-[11px] text-slate-300 font-sans leading-relaxed">
                          💡 {med.instructions}
                        </div>
                        ...
                        <div className="flex items-center justify-between text-[10px] pt-1">
                          ...
                          >
                            Stock: {med.stockCount} pills {isLowStock && '⚠️ (Refill soon)'}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-slate-800/80">
                        ...
                        {taken ? (
                          <div className="px-3.5 py-1.5 rounded-xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs font-bold flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="px-4 py-1.5 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-500 hover:from-emerald-300 text-black font-extrabold text-xs transition-all shadow-md shadow-emerald-500/20 flex items-center gap-1.5 cursor-pointer hover:scale-105"
                          >
